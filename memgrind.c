...
// B2******************
 ...
 {	
  ...
  {
   ptrArray1[index] = myMalloc(sizeof(char));
  }
  ...
  while(numOfMallocs < 1000)
  {
   ...
   {
    ptrArray2[numOfMallocs] = myMalloc(sizeof(char));
    numOfMallocs++;
   }
  ...
  while(numOfMallocs < 1000)
  {
   ...
   if((randomNum == 0) && (numOfMallocs < 1000))
   {
    ptrArray3[numOfMallocs] = myMalloc(randomNumBytes * sizeof(char));
    numOfMallocs++;
   }
 ...
 // Test F*******************************
  ...
  { 
    ...
    randomNumBytes = ((rand() % 256) + 1); 
   	char* ptr = myMalloc(randomNumBytes * sizeof(char));
  }
   endTime = clock();
   totalTime = ((double)(endTime - startTime))/CLOCKS_PER_SEC;
   testFtime += totalTime;
